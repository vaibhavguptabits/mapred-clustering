...
/**
 * Created by vaibhavguptabits on 27.09.15..
 */
       ...
       // cluster artifacts
        ...
        while (tokenStore.hasNext()) {
            ...
            //    System.out.println("END_CLUSTER_FLAG size: " + inputValues.size()+ " clusterId: "+clusterId+ " for line: "+token_counter);
                ...
                //here we just converted linked list and entity id to a entity object
                entities.add(cluster);

            }

//            input values is a linked list which contain all the values of a same key
//            we are just appending comma between each word
            if( SET_CLUSTER_FLAG  && is_CLUSTER_LINE ) {
                //entity line is the name
